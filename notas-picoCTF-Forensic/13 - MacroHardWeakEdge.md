...
```
jesus@jesus-ThinkPad-T420:~/picoCTF/forensic/MacroHardWeakEdge$ ls
'Forensics is fun.pptm'
jesus@jesus-ThinkPad-T420:~/picoCTF/forensic/MacroHardWeakEdge$ unzip Forensics\ is\ fun.pptm 
...
jesus@jesus-ThinkPad-T420:~/picoCTF/forensic/MacroHardWeakEdge$ ppt/slideMasters/hidden
bash: ppt/slideMasters/hidden: Permiso denegado
jesus@jesus-ThinkPad-T420:~/picoCTF/forensic/MacroHardWeakEdge$ ppt/slideMasters
bash: ppt/slideMasters: Es un directorio
jesus@jesus-ThinkPad-T420:~/picoCTF/forensic/MacroHardWeakEdge$ cd ppt/slideMasters/hidden
bash: cd: ppt/slideMasters/hidden: No es un directorio
jesus@jesus-ThinkPad-T420:~/picoCTF/forensic/MacroHardWeakEdge$ cat ppt/slideMasters/hidden
Z m x h Z z o g c G l j b 0 N U R n t E M W R f d V 9 r b j B 3 X 3 B w d H N f c l 9 6 M X A 1 f Qjesus@jesus-ThinkPad-T420:~/picoCTF/forensic/MacroHardWeakEdge$ cat ppt/slideMasters/hidden | tr ' ' '' | base64 -d 
tr: si no se está truncando conjunto1, cadena2 debe ser no vacía
jesus@jesus-ThinkPad-T420:~/picoCTF/forensic/MacroHardWeakEdge$ cat ppt/slideMasters/hidden | tr -d ' '  | base64 -d 
flag: picoCTF{D1d_u_kn0w_ppts_r_z1p5}base64: entrada inválida
jesus@jesus-ThinkPad-T420:~/picoCTF/forensic/MacroHardWeakEdge$
```

## Notas adicionales 
tr = intercambia valores, en este caso elimina los espacios 
