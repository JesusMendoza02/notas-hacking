...
```
jesus@jesus-ThinkPad-T420:~/picoCTF/Crypto/readmycert$ openssl req -text -noout -verify -in readmycert.csr 
verify OK
Certificate Request:
    Data:
        Version: 1 (0x0)
    ...
    Signature Algorithm: sha256WithRSAEncryption
         ...
         7d:b7:e9:9e
jesus@jesus-ThinkPad-T420:~/picoCTF/Crypto/readmycert$ 
